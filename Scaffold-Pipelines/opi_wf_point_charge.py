...
from utils import (
    ...
    add_anion_on_ci_axis_structure,
    atoms_to_structure
)
...
for row in ref_db.select():
    ...
    complex_struct = add_anion_on_ci_axis_structure(mol_struct,"Cl")
    ...
    final_struct, iodine_index = align_ci_xaxis_no_rdkit(final_struct, return_i_index=True)
    ...
    E_int = E_tot - mol_1_energy - chloride_sp
    ...
    atoms.info["Molecule Energy"] = E_tot
    ...
    db_kwargs = dict(
        ...
        E_mol=E_mol,
        Interaction_E = E_tot - (E_mol + -4.5998815786441452e+02), 
