...
for row in feat_db.select():
    ...
    # Expected shape: (2,) → [Vmin, Vmax]  or stored per-atom as (N, 2)
    if vmin_vmax.ndim == 2:
        vmax = float(vmin_vmax[i_index, 1])
    else:
        # 1-D array of length 2: [Vmin, Vmax]
...
# ══════════════════════════════════════════════════════════════════════════════
# Step 4 — ROBERT-style even train/test split (20% test)
